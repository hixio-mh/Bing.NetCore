...
namespace Bing.Datas.EntityFramework.Core
{
        ...
        where TPo : class, IKey<TKey>, IVersion, IPath
    {
        ...
        public virtual async Task<TEntity> FindByIdNoTrackingAsync(TKey id, CancellationToken cancellationToken = default(CancellationToken)) => ToEntity(await _store.FindByIdNoTrackingAsync(id, cancellationToken));
    }
}
